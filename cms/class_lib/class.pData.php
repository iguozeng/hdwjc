 ...
 class pData
  {
   ...
   function AddPoint($Value,$Serie="Serie1",$Description="")
    {
	 $Serie=$this->Gb2Utf8($Serie);
	 $Description=$this->Gb2Utf8($Description);
   ...
   function AddSerie($SerieName="Serie1")
    {
	 $SerieName=$this->Gb2Utf8($SerieName);
