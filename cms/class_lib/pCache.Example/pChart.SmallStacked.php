 ...
 */
 ...
 $DataSet->SetYAxisName("²âÊÔÖùÐÎÀÛ¼Ó");
 $DataSet->SetYAxisUnit("¸ö");
 ...
 $Test->Render("report/SmallStacked.png");
?>
<img src="report/SmallStacked.png" style="background-image:url(include/sysimg/report_bg.jpg);padding:15px 30px 10px 20px">