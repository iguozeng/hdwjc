 ...
 */
 ...
 $Test->drawTitle(50,22,"实例(2)",50,50,50,585);
 $Test->Render("report/example2.png");
?>
<img src="report/example2.png" style="background-image:url(include/sysimg/report_bg.jpg);padding:15px 30px 10px 20px">