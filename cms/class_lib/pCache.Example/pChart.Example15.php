 ...
 */
 ...
 $DataSet->AddPoint(array("一月","一月","一月","二月","二月","二月","三月","三月","三月","四月","四月","四月","五月","五月","五月"),"Serie4");
 $DataSet->AddAllSeries();
 $DataSet->SetAbsciseLabelSerie("Serie4");
 $DataSet->SetSerieName("最大均值","Serie1");
 $DataSet->SetSerieName("最小均值","Serie2");
 $DataSet->SetSerieName("温度","Serie3");
 $DataSet->SetYAxisName("温度");
 $DataSet->SetXAxisName("月/年");
 ...
 $Test->drawTitle(60,22,"实例(15)",50,50,50,585);

 // Add an image
 $Test->drawFromPNG("data/logo.png",584,35);

 // Render the chart
 $Test->Render("report/example15.png");   
?>
<img src="report/example15.png" style="background-image:url(include/sysimg/report_bg.jpg);padding:15px 30px 10px 20px">