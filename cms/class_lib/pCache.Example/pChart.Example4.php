 ...
 */
 ...
 // Dataset definition 
 $DataSet = new pData;
 $DataSet->ImportFromCSV("data/datawithtitle.csv",",",array(1,2,3),TRUE,0);
 ...
 $Test->drawTitle(60,22,"ÊµÀý(4)",50,50,50,585);
 $Test->Render("report/example4.png");
?>
<img src="report/example4.png" style="background-image:url(include/sysimg/report_bg.jpg);padding:15px 30px 10px 20px">