 ...
 */
 ...
 $Test->drawTitle(60,22,"ÊµÀý(6)",50,50,50,585);
 $Test->Render("report/example6.png");
?>
<img src="report/example6.png" style="background-image:url(include/sysimg/report_bg.jpg);padding:15px 30px 10px 20px">