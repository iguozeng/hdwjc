 ...
 */
 ...
 $Test->drawTitle(50,22,"实例(12)",50,50,50,585);
 $Test->Render("report/example12.png");
?>
<img src="report/example12.png" style="background-image:url(include/sysimg/report_bg.jpg);padding:15px 30px 10px 20px">