 ...
 */
 ...
 $Test->drawTitle(50,22,"ÊµÀý(18)",50,50,50,585);
 $Test->Render("report/example18.png");
?>
<img src="report/example18.png" style="background-image:url(include/sysimg/report_bg.jpg);padding:15px 30px 10px 20px">