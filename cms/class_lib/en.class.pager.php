...
class uobarpage {
	...
	public function __construct($total,$pagesize=10) {		
		if((!is_int($total))||($total<0))die("err result！");
		if((!is_int($pagesize))||($pagesize<0))die("err Pagesize！");
...
*/
	...
	public function limit2()
	{
			...
			return ('<b>Total:<font color=red>'.$this->total.'</font></b>,<font color=red>'.$this->current_pageno)."</font>/<font color=red>".$this->totalpage.'</font>';
